...
void ABlasterCharacter::AimOffset(float DeltaTime)
{
	...
	if (Speed == 0.f && !bIsInAir) // standing still, not jumping
	{
		...
		SetOrientationMode(EOrientationMode::EOM_LockToYaw);
...
void ABlasterCharacter::SetOrientationMode(EOrientationMode OrientationMode)
{
	switch (OrientationMode) 
	{
	case EOrientationMode::EOM_OrientWithMovement:
		GetCharacterMovement()->bOrientRotationToMovement = true;
		bUseControllerRotationYaw = false;
		break;
	case EOrientationMode::EOM_LockToYaw:
